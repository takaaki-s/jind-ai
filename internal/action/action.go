...
func CoreActions(kb KeyBindings) []Action {
	...
	return []Action{
		...
		// No Shortcut: the palette is deliberately the only way in, so
		// acknowledging stays a thing you go and do rather than something a
		// stray keystroke can do for you.
